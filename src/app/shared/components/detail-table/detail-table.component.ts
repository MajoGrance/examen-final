...
import { CRUDColumn } from '../crud/crud.component';
...
export class DetailTableComponent implements OnInit, OnChanges {
    ...
    /**
     * Si es verdadero el detalle se edita en linea.
     */
    @Input() inline = false;
    /**
     * Indicador de que se debe mostrar la cabecera.
    ...
    get showColumns(): CRUDColumn[] {
        return this.columns.filter(c => c.type !== 'hidden');
    }
